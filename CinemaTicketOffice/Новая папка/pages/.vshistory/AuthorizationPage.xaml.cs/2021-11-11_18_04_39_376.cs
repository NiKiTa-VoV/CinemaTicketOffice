...
namespace CinemaTicketOffice.pages
{
    ...
    public partial class AuthorizationPage : Page
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                System.Data.Entity.DbSet<clients> clients = ModelCinemaHandler.getContext().clients;
                ...
                List<clients> clientsSelect = clients.SqlQuery($"SELECT * FROM clients WHERE login = @login AND password = @password", loginParam, passwordParam).ToList();
